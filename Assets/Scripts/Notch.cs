...
public class Notch : XRSocketInteractor
{
    // Settings
    [Range(0, 1)]
    public float releaseThreshould = 0.25f;
    ...
    public void ReleaseArrow(SelectExitEventArgs args)
    {
        ...
        if (selectTarget is Arrow && PullMeasurer.PullAmount > releaseThreshould)
        {
            CustomManager.ForceDeselect(this);
            FindObjectOfType<Quiver>().currentArrow = null;
        }
        FindObjectOfType<PullMeasurer>().ResetBowParticle();
    }
